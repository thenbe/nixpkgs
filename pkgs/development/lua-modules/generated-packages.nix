...
lua-shepi = callPackage({ luaAtLeast, luaposix, buildLuarocksPackage, fetchgit, luaOlder, lua }:
buildLuarocksPackage {
  pname = "lua-shepi";
  version = "1.4-1";
  knownRockspec = (fetchurl {
    url    = "mirror://luarocks/lua-shepi-1.4-1.rockspec";
    sha256 = "14fz1x1ynj3x0xj5zb8k3zm3fsr32w2x04l2ngb0ah4v0kym3s7b";
  }).outPath;
  src = fetchgit ( removeAttrs (builtins.fromJSON ''{
  "url": "https://github.com/forflo/shepi",
  "rev": "e4a357fae6e160d8102566ea6fadadb146a152ff",
  "date": "2017-04-09T22:02:18+02:00",
  "path": "/nix/store/r0dndnslk8gbhv2wrbwvkpddrs1f9j2m-shepi",
  "sha256": "1s5nlx9fmp5zyk4g3cps3bry4jl8nb537yqmajzfvv4fxikmrfhy",
  "fetchLFS": false,
  "fetchSubmodules": true,
  "deepClone": false,
  "leaveDotGit": false
 ...
 '') ["date" "path"]) ;
  ...
  meta = {
    ...
    description = "Tiny EDSL for shell pipes in lua";
